      ...
      if(!isOpen){
        ...
        <div className="w-full">
          <div className="flex justify-between w-full">
           ...
           <button className="text-4xl font-bold mr-10" onClick={()=>setIsOpen(!isOpen)}>{isOpen?'˄':'⌄'}</button>
          </div>
          <div className="h-6 bg-gray-300 mt-2 mb-2 rounded-xl shadow-md"></div>
        </div>
      )
      ...
      if(foodselected==='veg'){
         return (
          ...
          <div className="w-full">
            ...
            <div className="h-6 bg-gray-300 rounded-xl mt-2 mb-2 shadow-md"></div>
          </div>
         )
      }
